        ...
        <div class="container ">
            ...
            <div class="tab-head ">
                <nav class="nav-sidebar">
                    <ul class="nav tabs ">
                        <li class="active"><a href="#tab1" data-toggle="tab" aria-expanded="false">Staples</a></li>
                        <li class=""><a href="#tab2" data-toggle="tab" aria-expanded="false">Snacks</a></li>
                        <li class=""><a href="#tab3" data-toggle="tab" aria-expanded="false">Fruits &amp; Vegetables</a></li>
                        <li class=""><a href="#tab4" data-toggle="tab" aria-expanded="true">Breakfast &amp; Cereal</a></li>
                    </ul>
                </nav>
