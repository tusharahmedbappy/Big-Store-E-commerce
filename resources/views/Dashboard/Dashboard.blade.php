...
<head>
    ...
    <!-- CSS Files -->
    <link href="{{asset('dashboard/assets/css/argon-dashboard.css?v=1.1.0')}}" rel="stylesheet" />
</head>
...
<!--   Optional JS   -->
<script src="{{asset('dashboard/assets/js/plugins/chart.js/dist/Chart.min.js')}}"></script>
<script src="{{asset('dashboard/assets/js/plugins/chart.js/dist/Chart.extension.js')}}"></script>
<!--   Argon JS   -->
<script src="{{asset('dashboard/assets/js/argon-dashboard.min.js?v=1.1.0')}}"></script>
